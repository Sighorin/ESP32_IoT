...
if uploaded_file is not None:
   ...
   min_temp = st.slider('Selecciona la temperatura mínima (°C)', min_value=23, max_value=28, value=23, key=1)
   ...
   max_temp = st.slider('Selecciona la temperatura mínima (°C)', min_value=23, max_value=28, value=23, key=2)
   # Filtrar el DataFrame utilizando query
